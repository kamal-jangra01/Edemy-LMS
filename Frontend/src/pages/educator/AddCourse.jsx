      ...
      >
        <div className="flex flex-col gap-1">
          ...
          <input
            ...
            className="outline-none md:py-2.5 py-2 px-3 rounded-gray-500"
            required
          />
        </div>
        <div className="flex flex-col gap-1">
        ...
        <div className="flex items-center justify-between flex-wrap">
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              value={coursePrice}
              placeholder="0"
              className="outline-none md:py-2.5 py-2 w-28 px-3 rounded boder border-gray-500"
              required
            />
          </div>
              ...
              <div className="flex justify-between items-center p-4 border-b">
                <div className="flex items-center">
                  <img
                    ...
                    width={14}
                    className={`mr-2 cursor-pointer transition-all ${chapter.collpsed && "-rotate-90"}`}
                    alt=""
                  />
